...
SV_sample=paste0("/n/data1/hms/dbmi/park/icortes/STR/pancan/SV_calls_1.6/",SV_sample)
...
segSample = read.csv(paste0("/n/data1/hms/dbmi/park/icortes/STR/pancan/chromothripsis_ICGC/",CNV),header=T,sep="\t",stringsAsFactors=F)
...
pdf(paste0(args[2],".pdf"),width=(12/2.4), height=(12/2.4))
...
#----------------------------------------------------------------------------------------
#par("lend"="butt")
#circos.genomicTrackPlotRegion(pepe,track.height = 0.25,
