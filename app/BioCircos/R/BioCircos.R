...
BioCircos <- function(tracklist = BioCircosTracklist(),
  ...
  SNPMouseOverTooltipsHtml03 = "<br/>Distance to next: ", SNPMouseOverTooltipsHtml04 = "<br/>",  SNPMouseOverTooltipsHtml05 = "",
  ...
  LINKMouseOverTooltipsHtml01 = "SV: ", LINKMouseOverTooltipsHtml02 = "",
  ...
  CNVMouseOverTooltipsHtml03 = "<br>End: ", CNVMouseOverTooltipsHtml04 = "<br>CN: ", CNVMouseOverTooltipsHtml05 = "",
...
BioCircosCNVTrack <- function(trackname, chromosomes, starts, ends, values,
  ...
  tabHist = suppressWarnings(rbind(unname(chromosomes), unname(starts), unname(ends), unname(abs(values))))
